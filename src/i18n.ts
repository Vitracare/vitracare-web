...
export const translations = {
  FR: {
    ...
    offre: {
      metaTitle: 'Prise de mesures gratuite à domicile à Bruxelles — VitraCare',
      metaDescription: "Demander un devis est toujours gratuit, où que vous soyez. À Bruxelles, nous nous déplaçons en plus gratuitement chez vous pour prendre les mesures — en dehors, ce déplacement coûte 50€, mais le devis reste gratuit si vous nous envoyez vos propres mesures.",
      eyebrow: 'Offre actuelle',
      badge: 'Déplacement gratuit à Bruxelles — 50€ en dehors',
      title: 'Prise de mesures gratuite à domicile à Bruxelles',
  ...
  NL: {
    ...
    offre: {
      metaTitle: 'Gratis opmeting aan huis in Brussel — VitraCare',
      metaDescription: 'Een offerte aanvragen is altijd gratis, waar u ook bent. In Brussel komen we bovendien gratis bij u langs om zelf op te meten — daarbuiten kost deze verplaatsing 50€, maar de offerte blijft gratis als u ons zelf uw afmetingen bezorgt.',
      eyebrow: 'Huidige aanbieding',
      badge: 'Gratis verplaatsing in Brussel — 50€ daarbuiten',
      title: 'Gratis opmeting aan huis in Brussel',
  ...
  EN: {
    ...
    offre: {
      metaTitle: 'Free Home Measurement Visit in Brussels — VitraCare',
      metaDescription: "Requesting a quote is always free, wherever you are. In Brussels, we also come to you free of charge to take the measurements — outside Brussels, this visit costs €50, but the quote itself stays free if you send us your own measurements.",
      eyebrow: 'Current offer',
      badge: 'Free visit in Brussels — €50 outside',
      title: 'Free home measurement visit in Brussels',
