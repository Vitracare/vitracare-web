...
export const translations = {
  FR: {
    ...
    teintes: {
      ...
      solaire_more: "Contrairement au film miroir, la teinte solaire reste transparente dans les deux sens : vous voyez clairement au travers, et depuis l'extérieur on voit aussi à l'intérieur. Son rôle est purement thermique : réduire la chaleur et les UV qui entrent par vos fenêtres, pour un confort optimal en été sans devoir fermer les volets ou installer une climatisation. C'est la solution la plus adaptée pour un salon plein sud, une véranda, ou toute pièce très exposée au soleil.",
