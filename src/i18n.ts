...
export const translations = {
  FR: {
    ...
    popup: {
      ...
      offerTitle: 'Devis gratuit à domicile à Bruxelles',
      offerSubtitle: 'Le devis est toujours gratuit. À Bruxelles, on se déplace aussi gratuitement pour prendre les mesures. En dehors, le déplacement coûte 50€ — vous pouvez sinon nous envoyer vos propres mesures pour un devis gratuit.',
    ...
    offre: {
      metaTitle: 'Devis gratuit à domicile à Bruxelles — VitraCare',
      metaDescription: "Le devis est toujours gratuit. À Bruxelles, nous nous déplaçons aussi gratuitement chez vous pour prendre les mesures — en dehors, le déplacement coûte 50€, mais le devis reste gratuit si vous nous envoyez vos propres mesures.",
      eyebrow: 'Offre actuelle',
      badge: 'Déplacement gratuit à Bruxelles — 50€ en dehors',
      title: 'Devis gratuit à domicile à Bruxelles',
      intro: "Prendre les bonnes mesures fait toute la différence pour un devis fiable. C'est pourquoi nous nous déplaçons chez vous pour évaluer votre projet et vous établir un devis précis — sans que vous ayez à mesurer quoi que ce soit vous-même. Ce déplacement est gratuit à Bruxelles ; en dehors, il coûte 50€. Dans tous les cas, le devis lui-même reste gratuit — vous pouvez aussi nous envoyer vos propres mesures pour l'obtenir sans déplacement.",
  ...
  NL: {
    ...
    popup: {
      ...
      offerTitle: 'Gratis offerte aan huis in Brussel',
      offerSubtitle: 'De offerte is altijd gratis. In Brussel komen we ook gratis langs om op te meten. Daarbuiten kost de verplaatsing 50€ — u kan ons ook zelf uw afmetingen bezorgen voor een gratis offerte.',
    ...
    offre: {
      metaTitle: 'Gratis offerte aan huis in Brussel — VitraCare',
      metaDescription: 'De offerte is altijd gratis. In Brussel komen we ook gratis bij u langs om op te meten — daarbuiten kost de verplaatsing 50€, maar de offerte blijft gratis als u ons zelf uw afmetingen bezorgt.',
      eyebrow: 'Huidige aanbieding',
      badge: 'Gratis verplaatsing in Brussel — 50€ daarbuiten',
      title: 'Gratis offerte aan huis in Brussel',
      intro: 'De juiste afmetingen nemen maakt het verschil voor een betrouwbare offerte. Daarom komen we bij u langs om uw project te evalueren en een nauwkeurige offerte op te stellen — zonder dat u zelf iets hoeft op te meten. Deze verplaatsing is gratis in Brussel; daarbuiten kost ze 50€. De offerte zelf blijft in elk geval gratis — u kan ons ook zelf uw afmetingen bezorgen om ze zonder verplaatsing te ontvangen.',
  ...
  EN: {
    ...
    popup: {
      ...
      offerTitle: 'Free Home Quote in Brussels',
      offerSubtitle: 'The quote is always free. In Brussels, we also visit you free of charge to take measurements. Outside Brussels, the visit costs €50 — or you can send us your own measurements for a free quote.',
    ...
    offre: {
      metaTitle: 'Free Home Quote in Brussels — VitraCare',
      metaDescription: "The quote is always free. In Brussels, we also visit you free of charge to take measurements — outside Brussels, the visit costs €50, but the quote itself stays free if you send us your own measurements.",
      eyebrow: 'Current offer',
      badge: 'Free visit in Brussels — €50 outside',
      title: 'Free home quote in Brussels',
      intro: "Taking accurate measurements makes all the difference for a reliable quote. That's why we come to your home to assess your project and prepare a precise quote — without you having to measure anything yourself. This visit is free in Brussels; outside Brussels, it costs €50. The quote itself always stays free — you can also send us your own measurements to get it without a visit.",
