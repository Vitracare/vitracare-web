...
export const translations = {
  FR: {
    ...
    teintes: {
      ...
      miroir_more: "De jour, ce film crée un effet miroir sans tain : il empêche totalement la vue depuis l'extérieur, tout en vous laissant une vue dégagée depuis l'intérieur. Il existe en plusieurs intensités selon l'orientation de vos fenêtres, et réduit aussi la chaleur et les UV. Un point à connaître : l'effet ne fonctionne que de jour, et s'inverse le soir si l'intérieur est éclairé, comme pour n'importe quelle fenêtre.",
      ...
      antieffraction_more: "Contrairement aux autres films, celui-ci ne joue pas sur l'intimité mais sur la sécurité : il reste totalement transparent. En cas de choc, le verre se fissure mais les éclats restent collés au film au lieu de tomber, ce qui complique fortement une effraction. Particulièrement utile pour les maisons isolées ou peu passantes.",
  ...
  NL: {
    ...
    teintes: {
      ...
      miroir_more: "Overdag creëert deze folie een spiegeleffect zonder tain: het zicht van buitenaf wordt volledig geblokkeerd, terwijl u vanbinnen een vrij uitzicht behoudt. Ze bestaat in verschillende intensiteiten naargelang de oriëntatie van uw ramen, en vermindert ook warmte en UV. Een aandachtspunt: het effect werkt enkel overdag en keert 's avonds om als het interieur verlicht is, zoals bij elk raam.",
      ...
      antieffraction_more: 'In tegenstelling tot de andere folies gaat het hier niet om privacy maar om veiligheid: de folie blijft volledig transparant. Bij een schok barst het glas, maar de scherven blijven aan de folie kleven in plaats van te vallen, wat een inbraak sterk bemoeilijkt. Bijzonder nuttig voor afgelegen of rustig gelegen woningen.',
  ...
  EN: {
    ...
    teintes: {
      ...
      miroir_more: "During the day, this film creates a one-way mirror effect: the view from outside is fully blocked, while you keep a clear view from inside. It comes in several intensities depending on your windows' orientation, and also reduces heat and UV. One thing to know: the effect only works during the day and reverses in the evening if the interior is lit, as with any window.",
      ...
      antieffraction_more: "Unlike the other films, this one isn't about privacy but about security: it stays completely transparent. On impact, the glass cracks but the shards stay stuck to the film instead of falling, which makes a break-in far harder. Particularly useful for secluded or quiet homes.",
