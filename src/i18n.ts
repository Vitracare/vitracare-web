...
export const translations = {
  FR: {
    ...
    popup: {
      ...
      offerSubtitle: 'Normalement facturé 50€, actuellement offert dans la région bruxelloise. En dehors, une participation de 50€ aux frais de déplacement est demandée. On se déplace, on prend les mesures, vous recevez un devis précis.',
    ...
    offre: {
      ...
      metaDescription: 'Nous nous déplaçons gratuitement chez vous à Bruxelles pour prendre les mesures et vous établir un devis précis — en dehors de Bruxelles, 50€ de frais de déplacement sont demandés.',
      eyebrow: 'Offre actuelle',
      badge: 'Gratuit à Bruxelles — 50€ de déplacement en dehors',
  ...
  NL: {
    ...
    popup: {
      ...
      offerSubtitle: 'Normaal 50€, momenteel gratis in het Brussels gewest. Daarbuiten wordt een bijdrage van 50€ in de verplaatsingskosten gevraagd. Wij komen langs, meten op, en u ontvangt een nauwkeurige offerte.',
    ...
    offre: {
      ...
      metaDescription: 'Wij komen gratis bij u langs in Brussel om op te meten en een nauwkeurige offerte op te stellen — buiten Brussel rekenen we 50€ verplaatsingskost.',
      eyebrow: 'Huidige aanbieding',
      badge: 'Gratis in Brussel — 50€ verplaatsing daarbuiten',
  ...
  EN: {
    ...
    popup: {
      ...
      offerSubtitle: 'Normally €50, currently free within the Brussels region. Outside Brussels, a €50 travel fee applies. We come to you, take measurements, and you receive an accurate quote.',
    ...
    offre: {
      ...
      metaDescription: 'We come to you free of charge in Brussels to take measurements and prepare an accurate quote — outside Brussels, a €50 travel fee applies.',
      eyebrow: 'Current offer',
      badge: 'Free in Brussels — €50 travel fee outside',
